...
This project is indexed by GitNexus as **lore** (182 symbols, 308 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
