...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return (
    <style
      // biome-ignore lint/security/noDangerouslySetInnerHtml: ChartStyle injects scoped CSS variables for chart theming — content is constructed from config keys, not user input
