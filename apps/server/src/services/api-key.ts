...
export const generateApiKey = (slug: string): string => {
  let suffix = "";
...
export const hashApiKey = (plain: string): Promise<string> => {
  return bcrypt.hash(plain, BCRYPT_COST);
};

export const compareApiKey = (plain: string, hash: string): Promise<boolean> => {
